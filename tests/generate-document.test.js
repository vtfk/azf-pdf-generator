...
const testDocumentsTypes = ['acos-innplasseringsbrev', 'iop-hemmelig', 'smart-motereferat', 'varsel-fag', 'varsel-orden', 'varsel-atferd', 'yff-bekreftelse', 'yff-bekreftelse-bedrift', 'yff-laereplan', 'yff-tilbakemelding', 'vigo-KONTRAKT-response']
